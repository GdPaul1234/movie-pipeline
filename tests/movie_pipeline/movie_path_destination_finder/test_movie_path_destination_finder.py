...
class TestMoviePathDestinationFinder(unittest.TestCase):
    def setUp(self) -> None:
        ...
        video_path = self.input_dir_path.joinpath('channel 1_Movie Name_2022-11-1601-20.mp4')
        serie_path = self.input_dir_path.joinpath('channel 1_Serie Name S01E23_2022-11-1601-20.mp4')
    ...
    def test_movie_resolve_destination(self):
        ...
        self.assertEqual(
            self.output_dir_movie_path.joinpath('Movie Name'),
    ...
    def test_serie_resolve_destination(self):
        ...
        self.assertEqual(
            self.output_dir_serie_path.joinpath('Serie Name', 'Saison 1'),
            finder.resolve_destination().resolve()
        )
    ...
    def test_existing_serie_resolve_destination(self):
        ...
        serie_folder = self.output_dir_serie_path.joinpath('Other Serie Name (2022)', 'Saison 2')
