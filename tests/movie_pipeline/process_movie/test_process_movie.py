...
class TestProcessMovie(unittest.TestCase):
    ...
    def test_movie_process(self):
        ...
        self.assertTrue((self.output_dir_movie_path / 'Movie Name' / 'Movie Name.mp4').exists())
        self.assertTrue((self.backup_dir_path / 'Movie Name' / 'channel 1_Movie Name_2022-11-1601-20.mp4').exists())
        self.assertTrue((self.backup_dir_path / 'Movie Name' / 'channel 1_Movie Name_2022-11-1601-20.mp4.yml').exists())
    ...
    def test_movie_skip_backup_process(self):
        ...
        self.assertTrue((self.output_dir_movie_path / 'Movie Name' / 'Movie Name.mp4').exists())
        self.assertFalse((self.backup_dir_path / 'Movie Name').exists())
